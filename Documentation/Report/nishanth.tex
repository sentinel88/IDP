...
\end{equation*}
This problem is the \textit{bilevel programming problem} or the \textit{leader's problem}.\\~\\
...
\end{equation*}
The set of pairs $\left(x,y\right)$ satisying the constraints of both the lower and upper levels, denoted by M, as well as the minimization problem of the objective functions of both the lower and the upper level problems marked by the arrows are depicted below in the figure.\\
\begin{figure}[h]
\centering
