...
%with f i :¼ f ð#iÞ. Further, f ðxÞ is a function in the single flow variable xa and #m P maxa2Axa has to hold. The trivial upper
%bound is
%P
%r2R;s2Sqrs. However, as xa can be much smaller than
%P
%r2R;s2Sqrs, empirical upper bounds can further improve the
%quality of the approximation. Define ai :¼ f if i1
%#i#i1
%and bi :¼ #i1ai þ f i1. Then f ðxÞ can be approximated by the following
