...
\item Figure 2 shows the pseudo code explaining the implementation details of the different selection schemes: Tournament selection, Random selection, and Rank selection(including how to assign selection probailities to the candidates).
...
%\label{fig:arch}
%\end{figure}
\nocite{fontaine,gao,poorzahedy2,tianze,leblanc,kuo,poorzahedy1,wen,andreas,obitko,iitm,bargera}
